...
class similarity(object):
    def __init__(self):
        ...
        self.state_dict = './checkpoint/all_ep_6_miou_0.74.pth'
    ...
    def vis(self, heatmap, dets, box_ipm_length, box_ipm, box_coor):
        ...
        for b in range(len(dets[0])):
            bb = dets[0][b]
            fig.axes.add_patch(plt.Rectangle(xy=(bb[0], bb[1]), width=bb[2]-bb[0], height=bb[3]-bb[1], fill=False, edgecolor='blue', linewidth=1))
...
if __name__ == '__main__':
    ...
    img = Image.open('/data/haojie/TRANCOS/train/image-1-000007.jpg')
